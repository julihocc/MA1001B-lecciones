...
\begin{frame}{Compara tres probabilidades exactas}
\small
La libreta enumera 165 perfiles y calcula el peso de tres de ellos con la misma fórmula.
\[
\begin{array}{c|c|c}
\text{Perfil}&\text{Asignaciones etiquetadas}&P\\\hline
(5,1,1,1)&336&0.00512695\\
(4,2,1,1)&840&0.01281738\\
(3,2,2,1)&1680&0.02563477
\end{array}
\]
Cada probabilidad divide su número de asignaciones entre $4^8=65\,536$.
\par\medskip
\textbf{Comprobación:} ¿Qué contamos en el numerador? Las asignaciones etiquetadas que producen el perfil, dado el modelo de enrutamiento.
\end{frame}
