...
\begin{frame}{Verificación de conceptos: respuestas sugeridas}
  \begin{enumerate}
    \item La regla del producto da $4\times3\times2=24$ configuraciones
      completas.
    \item Los dos roles son distintos, así que $P(5,2)=5\times4=20$
      asignaciones.
    \item El orden interno no cambia el panel, así que $\binom{5}{2}=10$
      paneles.
    \item Un conteo válido no puede exceder la cardinalidad de su universo.
      La expresión 420, por tanto, cuenta al menos algunos grupos finales
      más de una vez.
  \end{enumerate}

  \begin{block}{Nota para la persona instructora}
    Pida a los estudiantes que describan un resultado antes de nombrar una
    fórmula. En el último ítem, exija identificar la designación repetida de
    integrantes como fuente del sobreconteo.
  \end{block}
\end{frame}
