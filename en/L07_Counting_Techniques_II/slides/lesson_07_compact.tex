...
\begin{frame}{Compare three exact probabilities}
\small
The notebook enumerates 165 profiles and calculates the weights of three with the same formula.
\[
\begin{array}{c|c|c}
\text{Profile}&\text{Labeled assignments}&P\\\hline
(5,1,1,1)&336&0.00512695\\
(4,2,1,1)&840&0.01281738\\
(3,2,2,1)&1680&0.02563477
\end{array}
\]
Each probability divides its number of assignments by $4^8=65\,536$.
\par\medskip
\textbf{Check:} What is counted in the numerator? The labeled assignments producing the profile under the routing model.
\end{frame}
