...
\newcommand{\ruta}{Class route · 50 minutes}
...
\begin{frame}{Set Theory and Sample Spaces}
  \framesubtitle{Class route · 50 minutes}
...
\begin{frame}{Student consultation · Choose what to revisit}
  ...
  \begin{itemize}
    \item The $F$ exercise (worked solution in the companion notebook) and counterexamples.
