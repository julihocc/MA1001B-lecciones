...
\begin{frame}{Your learning route: 40 minutes}
  ...
  \begin{tabular}{p{.34\linewidth}rp{.45\linewidth}}
    ...
    Case and objectives & 4 & Interpret one dispatch.\\
    Sample space & 8 & Construct eight possibilities.\\
    Observations and events & 13 & Solve and program set questions.\\
    Event pair properties & 8 & Justify disjointness and coverage.\\
    Integration & 5 & Solve a new question.\\
    Closing check & 2 & Verify and bridge to L06.\\ \bottomrule
  \end{tabular}
  \par\medskip
  Follow intuition $\to$ formal definition $\to$ worked example $\to$ implementation $\to$ interpretation.
  Simulation details and additional proofs appear in the extended study materials.
\end{frame}
